...
// Helpers de formatação/conversão — implementação em ./format.ts (sem
// dependência deste client, para serem testáveis isoladamente).
export { kgToArrobas, formatBRL, maskBRLInput, parseBRLInput, formatDate, daysBetween } from './format';